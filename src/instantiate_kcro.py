...
AI DISCLOSURE
    ...
    resolution, deterministic IRI minting) and documentation. All AI-assisted
    code was reviewed by the author; the generated ABox was validated against the
    survey counts (--verify). See MAPPER.md for the full artefact description.
"""
